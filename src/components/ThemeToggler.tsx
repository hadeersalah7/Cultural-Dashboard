...
const ThemeToggler = () => {
    ...
    return (
        <div className="theme-toggle flex justify-center items-center lg:gap-2 cursor-pointer md:pr-5">
            <span
                className="text-xl text-[#8a2cf6] dark:text-white md:pr-2 lg:p-0"
